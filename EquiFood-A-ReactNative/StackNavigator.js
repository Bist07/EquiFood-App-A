...
import ViewCurrentRestaurants from './screens/ViewCurrentRestaurants';
...
function ROView() {
  return (
    ...
    initialRouteName = "RestaurantOwnerView">
      ...
      <Drawer.Screen name="Edit Restaurant Info" component={RestaurantInfoEditView} options={{
            drawerIcon: ({ color }) => (
                <AntDesign name={"edit"} size={20} color={color} />
            ),
      }}/>    
...
function AdminView() {
  return (
    ...
    initialRouteName = "Admin">
      ...
      <Drawer.Screen name="Current Restaurants" component={ViewCurrentRestaurants} options={{
            drawerIcon: ({ color }) => (
                <AntDesign name={"profile"} size={20} color={color} />
            ),
      }}/>    
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="ViewCurrentRestaurants" component={ViewCurrentRestaurants} options={{headerShown:false}}/>
