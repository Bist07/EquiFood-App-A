    ...
    <>
      ...
      <IonContent class='scroll-content' className='list' role="feed">
        ...
        <IonItem role="article">
          ...
          <img className='image' alt="Silhouette of mountains" src="https://order.subway.com/en-ca/-/media/northamerica/Canada/HomePageLogOut/Catering_Hockey-Night_3369-S.jpg?la=en-CA&h=640&w=640&mw=1280&hash=8360841CC2C4395EC39094BEF225FDC0" />
         <IonCardHeader>
            <IonButton className='button' expand="block" fill="outline" color="success" href='/tab2'> Subway </IonButton>
          </IonCardHeader>
          </IonCard> 
        </IonItem>
      ...
      <IonItem role="article">
          ...
          <IonCardHeader>
            <IonButton className='button' expand="block" fill="outline" color="success" href='/tab3'> Freshii </IonButton>
          </IonCardHeader>
          </IonCard> 
        </IonItem>
        ...
        <IonItem role="article" >
          <IonCard className='card'>
            ...
            <IonCardHeader>
              <IonButton className='button' expand="block" fill="outline" color="success" href='/tab4'> Jugo Juice </IonButton>
            </IonCardHeader>
            </IonCard> 
        </IonItem>
      </IonList>
